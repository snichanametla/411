...
extern T UArray2_new(int row, int col, int size); //creates a new 2D array
extern int UArray2_width(T uarray);// UArray2_rows: returns the total number of rows in the array. 
extern int UArray2_height(T uarray); //UArray2_cols: returns the total number of columns in the array.
 
extern void UArray2_map_row_major(T uarray, void apply(int i, int j, UArray2_T array2, void *elem, void *cl), void *cl);//UArray2_map_row_major: calls function apply on each element and its
                          //indices, along with a given closure pointer,
                          //going row by row. */
extern void UArray2_map_col_major(T uarray, void apply(int i, int j, UArray2_T array2, void *elem, void *cl), void *cl);//UArray2_map_col_major: calls
